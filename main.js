...
function draw() {
    ...
    if (status != "")
    {
        ...
        for (i = 0; i < objects.length; i++)
        {
            ...
            document.getElementById("number_of_objects").innerHTML = "Number of onjects detected are : " + objects.length;
    ...
    if (status != "person")
    {
     document.getElementById("babystatus").innerHTML =
            "Status : Baby Detected";
        audio.stop();
    }
    else {
        document.getElementById("babystatus").innerHTML =
            "Status : Baby Not Detected";
